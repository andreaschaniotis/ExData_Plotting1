...
par(mfrow=c(2,2))
plot(final_data$newtime,final_data$Global_active_power,xlab='',ylab='Global Active Power',type='l')
plot(final_data$newtime,final_data$Voltage,type='l',xlab='datetime',ylab='Voltage')
...
plot(final_data$newtime,final_data$Global_reactive_power,type='l',ylab='Global_reactive_power',xlab='datetime')
dev.off()